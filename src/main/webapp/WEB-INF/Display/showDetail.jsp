...
<tr><td>外观</td><td><img  onmouseover="enlarge(this)" onmouseout="reduction(this)" alt="药品图片" src="http://localhost:8080/images/drug/${drug.drugPic }" width="44" height="55"></td></tr>
